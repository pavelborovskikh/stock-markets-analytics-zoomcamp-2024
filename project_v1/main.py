...
def main():
    ...
    # =========================================
    # Step4: Make Inference and calculate financial results
    # =========================================
    print('Step 4: Making inference and calculating financial results')
    ...
    print(trained.df_full[trained.df_full[f'{prediction_name}_rank'] <= 2].sort_values(
        by=["Date", f'{prediction_name}_rank']).tail(10)[COLUMNS])
